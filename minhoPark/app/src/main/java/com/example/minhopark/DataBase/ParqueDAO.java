...
public class ParqueDAO implements Serializable {
    ...
    public Parque getParque(int parqueID) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                return new Parque(id,nome, imagem.getBytes(1, (int) imagem.length()),endereco,coordenadas,nrCriticas,rating,horarios,categorias);
    ...
    public boolean addParque(Parque parque){
        ...
        try{
            ...
            stmt.setBlob(3, new SerialBlob(parque.getImage()));
    ...
    public List<Parque> getParques(){
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Parque parque = new Parque(id,nome, imagem.getBytes(1, (int) imagem.length()), endereco,coordenadas,nrCriticas,rating,horarios,categorias);
    ...
    public static void main(String args[]){
        ...
        Parque p0 = new Parque(0,"Parque da Ponte",convertFileContentToBlob("./app/src/main/java/com/example/imgs/p0.jpg"), "N101 634, Braga", "41.5416871,-8.418896199999999",4296,(float)4.0,new ArrayList<Horario>(Arrays.asList(new Horario(0,LocalTime.of(00,00,00), LocalTime.of(23,59,59),"TODOS"))),new ArrayList<Categoria>(Arrays.asList(c1,c2)));
        Parque p1 = new Parque(1,"Jardim da Avenida Central",convertFileContentToBlob("./app/src/main/java/com/example/imgs/p1.jpg"),"Av. Central 116, 4710-249 Braga, Portugal","41.551536,-8.4216509",4670,(float)4.6,new ArrayList<Horario>(Arrays.asList(new Horario(1,LocalTime.of(00,00,00), LocalTime.of(23,59,59),"TODOS"))),new ArrayList<Categoria>(Arrays.asList(c9,c3)));
        Parque p2 = new Parque(2,"Parque da Rodovia",convertFileContentToBlob("./app/src/main/java/com/example/imgs/p2.jpg"),"4715-027 Braga, Portugal","41.5528282,-8.4031463",869,(float)4.7,new ArrayList<Horario>(Arrays.asList(new Horario(2, LocalTime.of(8,00,00), LocalTime.of(22,00,00),"TODOS"))),new ArrayList<Categoria>(Arrays.asList(c7,c2,c3,c6)));
        Parque p3 = new Parque(3,"Parque do Tribunal Judicial de Braga",convertFileContentToBlob("./app/src/main/java/com/example/imgs/p3.jpeg"),"R. Dr. Francisco Duarte 106110, 4715-156 Braga, Portugal","41.5482823,-8.4124714",0,(float) 0.0,new ArrayList<Horario>(Arrays.asList(new Horario(3, LocalTime.of(00,00,00), LocalTime.of(23,59,5),"TODOS"))),new ArrayList<Categoria>(Arrays.asList(c3)));;
        Parque p4 = new Parque(4,"Parque Infantil Areal de Cima",convertFileContentToBlob("./app/src/main/java/com/example/imgs/p4.png"),"R. Q.ta de Passos 127-89, 4710-426 Braga, Portugal","41.5651917,-8.408154",0,(float)0.0,new ArrayList<Horario>(Arrays.asList(new Horario(4, LocalTime.of(00,00,00), LocalTime.of(23,59,5),"TODOS"))),new ArrayList<Categoria>(Arrays.asList(c3)));;
        Parque p5 = new Parque(5,"Parque do Monte do Picoto",convertFileContentToBlob("./app/src/main/java/com/example/imgs/p5.jpg"),"Monte do Picoto, 4715-213 Braga, Portugal","41.53776879999999,-8.414022",803,(float)4.5,new ArrayList<Horario>(Arrays.asList(new Horario(5, LocalTime.of(8,00,00), LocalTime.of(23,00,00), "TODOS"))), new ArrayList<Categoria>(Arrays.asList(c2,c3,c5,c6)));;
        Parque p6 = new Parque(6,"Parque Fraião",convertFileContentToBlob("./app/src/main/java/com/example/imgs/p6.jpg"),"R. Victor de Sá 59, 4715-213 Braga, Portugal","41.5373447,-8.4032868",1,(float)3.0,new ArrayList<Horario>(Arrays.asList(new Horario(6, LocalTime.of(00,00,00), LocalTime.of(23,59,5),"TODOS"))),new ArrayList<Categoria>(Arrays.asList(c2,c3)));;
        Parque p7 = new Parque(7,"Parque de Street Workout das Andorinhas",convertFileContentToBlob("./app/src/main/java/com/example/imgs/p7.jpg"), "Braga, Portugal","41.55745719999999,-8.4290608",7,(float)4.3,new ArrayList<Horario>(Arrays.asList(new Horario(7, LocalTime.of(00,00,00), LocalTime.of(23,59,5),"TODOS"))),new ArrayList<Categoria>(Arrays.asList(c2,c3)));;
        Parque p8 = new Parque(8,"Parque Infantil do Pachancho",convertFileContentToBlob("./app/src/main/java/com/example/imgs/p8.jpg"), "4710-345 Braga, Portugal","41.56118012989272,-8.415635129892722",90,(float)4.2,new ArrayList<Horario>(Arrays.asList(new Horario(8, LocalTime.of(00,00,00), LocalTime.of(23,59,5), "TODOS"))), new ArrayList<Categoria>(Arrays.asList(c3)));;
        Parque p9 = new Parque(9,"Jardim da Casa dos Biscaínhos",convertFileContentToBlob("./app/src/main/java/com/example/imgs/p10.png"), "R. Andrade Corvo 54, 4700-415 Braga, Portugal","41.5508225,-8.4302463",1,(float)5.0,new ArrayList<Horario>(Arrays.asList(new Horario(9, LocalTime.of(9,30,00), LocalTime.of(17,30,00), "TODOS"))), new ArrayList<Categoria>(Arrays.asList(c9)));
        Parque p10 = new Parque(10,"Parque das Camélias",convertFileContentToBlob("./app/src/main/java/com/example/imgs/p11.jpg"), "Braga, Portugal","41.539578,-8.423485699999999",3,(float)4.3,new ArrayList<Horario>(Arrays.asList(new Horario(10, LocalTime.of(00,00,00), LocalTime.of(23,59,59), "TODOS"))), new ArrayList<Categoria>(Arrays.asList(c2)));
        Parque p11 = new Parque(11,"Parque de merendas da Amarela",convertFileContentToBlob("./app/src/main/java/com/example/imgs/p12.png"), "Braga, Portugal","41.5374288,-8.4503404",130,(float)3.9,new ArrayList<Horario>(Arrays.asList(new Horario(11, LocalTime.of(00,00,00), LocalTime.of(23,59,59), "TODOS"))), new ArrayList<Categoria>(Arrays.asList(c1)));
        Parque p12 = new Parque(12,"Parque do  Lago do Bom Jesus",convertFileContentToBlob("./app/src/main/java/com/example/imgs/p12.JPG"), "4715, Braga, Portugal","41.5549268,-8.3752076",181,(float)4.7,new ArrayList<Horario>(Arrays.asList(new Horario(12, LocalTime.of(00,00,00), LocalTime.of(23,59,59), "TODOS"))), new ArrayList<Categoria>(Arrays.asList(c1)));
        Parque p13 = new Parque(13,"Parque Temático do Arnado",convertFileContentToBlob("./app/src/main/java/com/example/imgs/p13.jpg"), "Caminho da Oliveirinha, 4990-150 Pte. de Lima, Portugal","41.771224,-8.5886332",105,(float)4.4,new ArrayList<Horario>(Arrays.asList(new Horario(13, LocalTime.of(9,00,00), LocalTime.of(19,00,00), "TODOS"))), new ArrayList<Categoria>(Arrays.asList(c2)));
        Parque p14 = new Parque(14,"Parque Campismo de Braga",convertFileContentToBlob("./app/src/main/java/com/example/imgs/p14.jpg"), "Portugal, N101 12, Braga","41.53911567460526, -8.422014984657952",395,(float)3.8,new ArrayList<Horario>(Arrays.asList(new Horario(14, LocalTime.of(00,00,00), LocalTime.of(23,59,59), "TODOS"))), new ArrayList<Categoria>(Arrays.asList(c4)));
        Parque p15 = new Parque(15,"Parque Campismo de Guimarães",convertFileContentToBlob("./app/src/main/java/com/example/imgs/p15.jpg"), "Alameda de Rosas Guimarães 4805, 4805-156 Caldelas","41.484276818172376, -8.341926146026143",560,(float)4.0,new ArrayList<Horario>(Arrays.asList(new Horario(15, LocalTime.of(00,00,00), LocalTime.of(23,59,59), "TODOS"))), new ArrayList<Categoria>(Arrays.asList(c4)));
        Parque p16 = new Parque(16,"Parque da Cidade de Guimarẽs",convertFileContentToBlob("./app/src/main/java/com/example/imgs/p16.jpg"), "Guimarães,Braga, Portugal","41.44690860635031, -8.280651430684095",1199,(float)4.6,new ArrayList<Horario>(Arrays.asList(new Horario(16, LocalTime.of(00,00,00), LocalTime.of(23,59,59), "TODOS"))), new ArrayList<Categoria>(Arrays.asList(c1,c2,c3,c7)));
        Parque p17 = new Parque(17,"Parque do Santuário da Penha",convertFileContentToBlob("./app/src/main/java/com/example/imgs/p17.jpg"), "Penha, Guimarães, Portugal","41.43085660072449, -8.268921453345442",167,(float)4.7,new ArrayList<Horario>(Arrays.asList(new Horario(17, LocalTime.of(00,00,00), LocalTime.of(23,59,59), "TODOS"))), new ArrayList<Categoria>(Arrays.asList(c1,c2)));
        Parque p18 = new Parque(18,"Jardim do Castelo de Guimarães",convertFileContentToBlob("./app/src/main/java/com/example/imgs/p18.png"), "Caminho do Castelo, 4810-245 Guimarães","41.44710828794814, -8.290222049554965",4,(float)4.8,new ArrayList<Horario>(Arrays.asList(new Horario(18, LocalTime.of(00,00,00), LocalTime.of(23,59,59), "TODOS"))), new ArrayList<Categoria>(Arrays.asList(c2)));
        Parque p19 = new Parque(19,"Parque da Vila",convertFileContentToBlob("./app/src/main/java/com/example/imgs/p19.jpg"), "Via de S. Bento (Estrada da Madalena) 4990-205 Ponte de Lima","41.45462,-8.34301",223,(float)4.6,new ArrayList<Horario>(Arrays.asList(new Horario(19, LocalTime.of(00,00,00), LocalTime.of(23,59,59), "TODOS"))), new ArrayList<Categoria>(Arrays.asList(c2)));
        Parque p20 = new Parque(20,"Parque do Festival Internacional de Jardins",convertFileContentToBlob("./app/src/main/java/com/example/imgs/p20.jpg"), "Caminho São Gonçalo, 4990-150 Pte. de Lima","41.76594512916375, -8.59145632128427",1498,(float)4.5,new ArrayList<Horario>(Arrays.asList(new Horario(20, LocalTime.of(00,00,00), LocalTime.of(23,59,59), "TODOS"))), new ArrayList<Categoria>(Arrays.asList(c2,c9)));
        ...
        Parque p22 = new Parque(22,"Parque de Valinhas",convertFileContentToBlob("./app/src/main/java/com/example/imgs/p22.jpg"), "R. da Breia 598, Carvoeiro","41.66398794545511, -8.6705284716176",89,(float)4.6,new ArrayList<Horario>(Arrays.asList(new Horario(22, LocalTime.of(00,00,00), LocalTime.of(23,59,59), "TODOS"))), new ArrayList<Categoria>(Arrays.asList(c1,c2)));
        Parque p23 = new Parque(23,"Parque Aventura",convertFileContentToBlob("./app/src/main/java/com/example/imgs/p23.jpg"), "Caminho da Alegria - Facha, 4990-600 Pte. de Lima","41.66398794545511,-8.6705284716176",89,(float)4.6,new ArrayList<Horario>(Arrays.asList(new Horario(23, LocalTime.of(9,00,00), LocalTime.of(19,00,00),"TODOS"))),new ArrayList<Categoria>(Arrays.asList(c1)));
        Parque p24 = new Parque(24,"Parque da Cidade de Viana",convertFileContentToBlob("./app/src/main/java/com/example/imgs/p24.jpg"),"Viana do Castelo, Ponte de Lima, Portugal","41.6968733997282,-8.818275501874414",232,(float)4.3,new ArrayList<Horario>(Arrays.asList(new Horario(24, LocalTime.of(00,00,00), LocalTime.of(23,59,59),"TODOS"))),new ArrayList<Categoria>(Arrays.asList(c2,c6,c7)));
